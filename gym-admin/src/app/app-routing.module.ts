...
const routes: Routes = [
  ...
  {path:"clientes", 
    children:[
      ...
      {path:":id", component: UpdateClienteComponent},  
    ],
  },
  {path:"entrenadores", 
    children:[
      {path:"", component: IndexEntrenadorComponent},
      {path:"add", component: AddEntrenadorComponent},
      {path:"ejercicios", children:[
        {path:"", component: IndexEjercicioComponent},
        {path:"add", component: AddEjercicioComponent},
        {path:":id", component: UpdateEjercicioComponent}
      ]},
      {path:"tests", children:[
        {path:"", component: IndexTestComponent},
        {path:"add", component: AddTestComponent},
        {path:"addEjercicio/:id", component: AddEjerciciosComponent},
        {path:":id", component: UpdateTestComponent},
      ]},
      {path:":id", component: UpdateEntrenadorComponent}, 
    ],
  },
